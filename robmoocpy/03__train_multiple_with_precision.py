...
tau = 10 # temps de retard entre les consignes des robots 

for t in arange(0,30,dt) :


    w, dw, ddw = target_w(t)
    wb, dwb, ddwb = target_w(t-tau) #w - l*array([[cos(x[2,0])],[sin(x[2,0])]]) # position à suivre du 2ème robot
    wc, dwc, ddwc = target_w(t-2*tau) #wb - l*array([[cos(xb[2,0])],[sin(xb[2,0])]]) # position à suivre du 3ème robot
